...
var LanguageManager = (function () {
    ...
    Object.defineProperty(LanguageManager, "getInstance", {
        get: function () {
            if (!this._instance) {
        ...
        for (var i = 0; i < node.numChildren; i++) {
            ...
            if (child instanceof eui.Label) {
                if (child.name != "") {
                    ...
                    if (name) {
                        child.text = LanguageManager.getInstance.getLanguageById(name);
                    }
                }
            }
                ...
                if (child.name != "") {
                    var name = child.name.split("@")[1];
                    if (name) {
                        child.prompt = LanguageManager.getInstance.getLanguageById(name);
                    }
                }
            }
                ...
                if (child.name != "") {
                    var name = child.name.split("@")[1];
                    if (name) {
                        child.label = LanguageManager.getInstance.getLanguageById(name);
                    }
                }
            }
        }
