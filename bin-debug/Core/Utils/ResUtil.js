...
var ResUtil = (function () {
    ...
    Object.defineProperty(ResUtil.prototype, "loadingGroups", {
        get: function () { return this._loadingGroups; },
        enumerable: true,
        configurable: true
    });
    /**
     ...
     * @group 资源组(支持字符串和数组)
     */
    ResUtil.prototype.loadGroupQuiet = function (group, priority) {
     ...
     * @priority 优先级
     */
    ResUtil.prototype.loadGroup = function (group, onComplete, thisObject, priority) {
        if (priority === void 0) { priority = 1; }
        var groupName = this.combGroupName(group);
    ...
    ResUtil.prototype.loadAsyncSound = function (path, backcall) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                RES.getResByUrl(PathManager.Instance.SoundPath + path, function () {
                    if (backcall)
                        backcall();
    ...
    Object.defineProperty(ResUtil, "getInstance", {
        get: function () {
            if (ResUtil._instance == null) {
                ResUtil._instance = new ResUtil();
            }
            return ResUtil._instance;
        },
        enumerable: true,
        configurable: true
    });
