...
var BoneAnimation = (function (_super) {
    ...
    BoneAnimation.prototype.load = function () {
        ...
        ResUtil.getInstance.loadGroup(this._skeName, this.loadComplete, this, ResUtil.PRIORITY_H);
    };
    ...
    BoneAnimation.prototype.loadComplete = function () {
        ...
        this.armature = BoneManager.Instance.getArmature(this._skeName);
    ...
    * */
    BoneAnimation.prototype.resetForPool = function () {
        ...
        DisplayUtils.resetDisplay(this);
        DisplayUtils.resetDisplay(this.armature.display);
    };
    ...
    BoneAnimation.prototype.onBoneRemove = function () {
        ...
        if (!ResourcePool.getIntance().hasItem(this, ResourcePool.SKE)) {
            ResourcePool.getIntance().push(this, ResourcePool.SKE);
        }
    };
