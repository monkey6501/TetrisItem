window.skins={};
	...
	return VSliderSkin;
})(eui.Skin);generateEUI.paths['resource/gameSkins/game/BlockItemSkin.exml'] = window.BlockItemSkin = (function (_super) {
	__extends(BlockItemSkin, _super);
	function BlockItemSkin() {
		_super.call(this);
		this.skinParts = ["icon"];
	...
	var _proto = BlockItemSkin.prototype;
	...
	return BlockItemSkin;
})(eui.Skin);generateEUI.paths['resource/gameSkins/game/GameMainViewSkin.exml'] = window.GameMainViewSkin = (function (_super) {
	...
	function TetrisItemSkin() {
		_super.call(this);
		this.skinParts = ["iconGroup"];
		
		this.elementsContent = [this.iconGroup_i()];
	}
	var _proto = TetrisItemSkin.prototype;
	...
	return TetrisItemSkin;
})(eui.Skin);generateEUI.paths['resource/gameSkins/login/LoginViewSkin.exml'] = window.LoginViewSkin = (function (_super) {
